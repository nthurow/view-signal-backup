...
$root.signal = (function() {
    ...
    signal.SqlStatement = (function() {
        ...
        SqlStatement.encode = function encode(message, writer) {
            ...
            if (message.parameters != null && message.parameters.length)
                for (var i = 0; i < message.parameters.length; ++i)
                    $root.signal.SqlStatement.SqlParameter.encode(message.parameters[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            return writer;
        };
        ...
        SqlStatement.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.signal.SqlStatement();
        ...
        SqlStatement.fromObject = function fromObject(object) {
            if (object instanceof $root.signal.SqlStatement)
                return object;
            ...
            if (object.parameters) {
                if (!Array.isArray(object.parameters))
                    throw TypeError(".signal.SqlStatement.parameters: array expected");
                message.parameters = [];
        ...
        SqlStatement.SqlParameter = (function() {
            ...
            SqlParameter.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.signal.SqlStatement.SqlParameter();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            SqlParameter.verify = function verify(message) {
                if (typeof message !== "object" || message === null)
                    return "object expected";
                if (message.stringParamter != null && message.hasOwnProperty("stringParamter"))
                    if (!$util.isString(message.stringParamter))
                        return "stringParamter: string expected";
                if (message.integerParameter != null && message.hasOwnProperty("integerParameter"))
                    if (!$util.isInteger(message.integerParameter) && !(message.integerParameter && $util.isInteger(message.integerParameter.low) && $util.isInteger(message.integerParameter.high)))
                        return "integerParameter: integer|Long expected";
                if (message.doubleParameter != null && message.hasOwnProperty("doubleParameter"))
                    if (typeof message.doubleParameter !== "number")
                        return "doubleParameter: number expected";
                if (message.blobParameter != null && message.hasOwnProperty("blobParameter"))
                    if (!(message.blobParameter && typeof message.blobParameter.length === "number" || $util.isString(message.blobParameter)))
                        return "blobParameter: buffer expected";
                if (message.nullparameter != null && message.hasOwnProperty("nullparameter"))
                    if (typeof message.nullparameter !== "boolean")
                        return "nullparameter: boolean expected";
                return null;
            };
            ...
            SqlParameter.fromObject = function fromObject(object) {
                if (object instanceof $root.signal.SqlStatement.SqlParameter)
                    return object;
                var message = new $root.signal.SqlStatement.SqlParameter();
                if (object.stringParamter != null)
                    message.stringParamter = String(object.stringParamter);
                if (object.integerParameter != null)
                    if ($util.Long)
                        (message.integerParameter = $util.Long.fromValue(object.integerParameter)).unsigned = true;
                    else if (typeof object.integerParameter === "string")
                        message.integerParameter = parseInt(object.integerParameter, 10);
                    else if (typeof object.integerParameter === "number")
                        message.integerParameter = object.integerParameter;
                    else if (typeof object.integerParameter === "object")
                        message.integerParameter = new $util.LongBits(object.integerParameter.low >>> 0, object.integerParameter.high >>> 0).toNumber(true);
                if (object.doubleParameter != null)
                    message.doubleParameter = Number(object.doubleParameter);
                if (object.blobParameter != null)
                    if (typeof object.blobParameter === "string")
                        $util.base64.decode(object.blobParameter, message.blobParameter = $util.newBuffer($util.base64.length(object.blobParameter)), 0);
                    else if (object.blobParameter.length)
                        message.blobParameter = object.blobParameter;
                if (object.nullparameter != null)
                    message.nullparameter = Boolean(object.nullparameter);
                return message;
            };
            ...
            SqlParameter.toObject = function toObject(message, options) {
                ...
                if (options.defaults) {
                    ...
                    if ($util.Long) {
                        ...
                        object.integerParameter = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                    } else
                        object.integerParameter = options.longs === String ? "0" : 0;
                    ...
                    if (options.bytes === String)
                        ...
                        if (options.bytes !== Array)
                            object.blobParameter = $util.newBuffer(object.blobParameter);
                    }
                ...
                if (message.integerParameter != null && message.hasOwnProperty("integerParameter"))
                    if (typeof message.integerParameter === "number")
                        object.integerParameter = options.longs === String ? String(message.integerParameter) : message.integerParameter;
                    else
                        object.integerParameter = options.longs === String ? $util.Long.prototype.toString.call(message.integerParameter) : options.longs === Number ? new $util.LongBits(message.integerParameter.low >>> 0, message.integerParameter.high >>> 0).toNumber(true) : message.integerParameter;
                if (message.doubleParameter != null && message.hasOwnProperty("doubleParameter"))
                    object.doubleParameter = options.json && !isFinite(message.doubleParameter) ? String(message.doubleParameter) : message.doubleParameter;
                if (message.blobParameter != null && message.hasOwnProperty("blobParameter"))
                    object.blobParameter = options.bytes === String ? $util.base64.encode(message.blobParameter, 0, message.blobParameter.length) : options.bytes === Array ? Array.prototype.slice.call(message.blobParameter) : message.blobParameter;
                if (message.nullparameter != null && message.hasOwnProperty("nullparameter"))
    ...
    signal.SharedPreference = (function() {
        ...
        SharedPreference.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.signal.SharedPreference();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        SharedPreference.fromObject = function fromObject(object) {
            if (object instanceof $root.signal.SharedPreference)
                return object;
    ...
    signal.Attachment = (function() {
        ...
        Attachment.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.signal.Attachment();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Attachment.verify = function verify(message) {
            ...
            if (message.attachmentId != null && message.hasOwnProperty("attachmentId"))
                if (!$util.isInteger(message.attachmentId) && !(message.attachmentId && $util.isInteger(message.attachmentId.low) && $util.isInteger(message.attachmentId.high)))
        ...
        Attachment.fromObject = function fromObject(object) {
            if (object instanceof $root.signal.Attachment)
                return object;
            ...
            if (object.attachmentId != null)
                if ($util.Long)
                    (message.attachmentId = $util.Long.fromValue(object.attachmentId)).unsigned = true;
                else if (typeof object.attachmentId === "string")
                    message.attachmentId = parseInt(object.attachmentId, 10);
                else if (typeof object.attachmentId === "number")
                    message.attachmentId = object.attachmentId;
                else if (typeof object.attachmentId === "object")
                    message.attachmentId = new $util.LongBits(object.attachmentId.low >>> 0, object.attachmentId.high >>> 0).toNumber(true);
        ...
        Attachment.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                if ($util.Long) {
                    var long = new $util.Long(0, 0, true);
                    object.attachmentId = options.longs === String ? long.toString() : options.longs === Number ? long.toNumber() : long;
                } else
                    object.attachmentId = options.longs === String ? "0" : 0;
                object.length = 0;
            }
            if (message.rowId != null && message.hasOwnProperty("rowId"))
            ...
            if (message.attachmentId != null && message.hasOwnProperty("attachmentId"))
                if (typeof message.attachmentId === "number")
                    ...
                    object.attachmentId = options.longs === String ? $util.Long.prototype.toString.call(message.attachmentId) : options.longs === Number ? new $util.LongBits(message.attachmentId.low >>> 0, message.attachmentId.high >>> 0).toNumber(true) : message.attachmentId;
            if (message.length != null && message.hasOwnProperty("length"))
    ...
    signal.Avatar = (function() {
        ...
        Avatar.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.signal.Avatar();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Avatar.fromObject = function fromObject(object) {
            if (object instanceof $root.signal.Avatar)
                return object;
    ...
    signal.DatabaseVersion = (function() {
        ...
        DatabaseVersion.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.signal.DatabaseVersion();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        DatabaseVersion.fromObject = function fromObject(object) {
            if (object instanceof $root.signal.DatabaseVersion)
                return object;
    ...
    signal.Header = (function() {
        ...
        Header.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.signal.Header();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Header.fromObject = function fromObject(object) {
            if (object instanceof $root.signal.Header)
                return object;
    ...
    signal.BackupFrame = (function() {
        ...
        BackupFrame.encode = function encode(message, writer) {
            ...
            if (message.preference != null && message.hasOwnProperty("preference"))
                $root.signal.SharedPreference.encode(message.preference, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
        ...
        BackupFrame.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.signal.BackupFrame();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        BackupFrame.fromObject = function fromObject(object) {
            if (object instanceof $root.signal.BackupFrame)
                return object;
            var message = new $root.signal.BackupFrame();
            if (object.header != null) {
                if (typeof object.header !== "object")
                    throw TypeError(".signal.BackupFrame.header: object expected");
                message.header = $root.signal.Header.fromObject(object.header);
            }
            if (object.statement != null) {
                if (typeof object.statement !== "object")
                    throw TypeError(".signal.BackupFrame.statement: object expected");
            ...
            if (object.avatar != null) {
                if (typeof object.avatar !== "object")
                    throw TypeError(".signal.BackupFrame.avatar: object expected");
